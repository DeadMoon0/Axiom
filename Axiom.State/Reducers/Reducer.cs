...
public abstract class Reducer<TState> where TState : struct
{
    ...
    protected void On<T1, T2, T3, T4, T5, T6>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!)); }
    protected void On<T1, T2, T3, T4, T5, T6, T7>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!, (T7)args[6]!)); }
    protected void On<T1, T2, T3, T4, T5, T6, T7, T8>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!, (T7)args[6]!, (T8)args[7]!)); }
    protected void On<T1, T2, T3, T4, T5, T6, T7, T8, T9>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!, (T7)args[6]!, (T8)args[7]!, (T9)args[8]!)); }
    protected void On<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!, (T7)args[6]!, (T8)args[7]!, (T9)args[8]!, (T10)args[9]!)); }
    protected void On<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!, (T7)args[6]!, (T8)args[7]!, (T9)args[8]!, (T10)args[9]!, (T11)args[10]!)); }
    protected void On<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!, (T7)args[6]!, (T8)args[7]!, (T9)args[8]!, (T10)args[9]!, (T11)args[10]!, (T12)args[11]!)); }
    protected void On<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!, (T7)args[6]!, (T8)args[7]!, (T9)args[8]!, (T10)args[9]!, (T11)args[10]!, (T12)args[11]!, (T13)args[12]!)); }
    protected void On<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!, (T7)args[6]!, (T8)args[7]!, (T9)args[8]!, (T10)args[9]!, (T11)args[10]!, (T12)args[11]!, (T13)args[12]!, (T14)args[13]!)); }
    protected void On<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>
        ...
        { OnInner(action, (state, args) => transformer(state, (T1)args[0]!, (T2)args[1]!, (T3)args[2]!, (T4)args[3]!, (T5)args[4]!, (T6)args[5]!, (T7)args[6]!, (T8)args[7]!, (T9)args[8]!, (T10)args[9]!, (T11)args[10]!, (T12)args[11]!, (T13)args[12]!, (T14)args[13]!, (T15)args[14]!)); }
